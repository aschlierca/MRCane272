...
namespace MoreMountains.NiceVibrations
{
    ...
    public class MMNVBuildPostProcessor : IPostprocessBuildWithReport
    {
        ...
        public static void SettingPlist(string path)
        {
            ...
            // Set the NSMotionUsageDescription key
            PlistElementDict rootDict = plist.root;
            rootDict.SetString("NSMotionUsageDescription", "We use your motion data to provide an enhanced experience in our app by detecting motion and activity.");

            // Write the modified Info.plist back to the file
