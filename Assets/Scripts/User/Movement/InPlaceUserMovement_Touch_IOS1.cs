...
public class InPlaceUserMovement_Touch_IOS1 : MonoBehaviour
{
    ...
    void PositionControl()
    {
        ...
        if (isTouching)
        {
            ...
            gripPoint.transform.position += Vector3.Scale(arCamForward * 0.3f * Time.deltaTime, new Vector3(1, 0, 1)); ;
